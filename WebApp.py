...
def basic_text_cleaning(line_from_column, clean_text_toggle=True):
    ...
    return ' '.join(final_doc) if clean_text_toggle else line_from_column
...
if __name__ == '__main__':
    ...
    # Toggle for text cleaning
    clean_text_toggle = st.checkbox("Enable Text Cleaning", value=True)
    ...
    # Set dark mode if the checkbox is selected
    if dark_mode:
        st.markdown(
            """
            <style>
